...
Base file: pointer-safe-20.smt2")
(set-info :source |
...
(assert (sum x_134 (+ x_73 (+ x_17 x_9))))
(assert (sum x_138 (+ x_102 (+ x_111 x_135))))
(assert (sum x_10 (+ x_229 (+ x_240 x_209))))
(assert (sum x_39 (+ x_247 (+ x_98 x_199))))
(assert (sum x_189 (+ x_60 (+ x_126 x_161))))
(assert (sum x_10 (+ x_232 (+ x_177 x_53))))
(assert (sum x_28 (+ x_197 (+ x_243 x_231))))
(assert (sum x_226 (+ x_17 (+ x_115 x_58))))
(assert (sum x_16 (+ x_18 (+ x_241 x_247))))
(assert (sum x_156 (+ x_231 (+ x_48 x_99))))
(check-sat)
(exit)