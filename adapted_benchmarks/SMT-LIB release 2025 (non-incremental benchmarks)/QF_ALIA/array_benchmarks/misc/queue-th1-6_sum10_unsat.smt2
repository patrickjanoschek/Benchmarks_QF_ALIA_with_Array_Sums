...
(assert (sum x_26 (+ x_25 (+ x_38 x_19))))
(assert (sum x_39 (+ x_38 (+ x_27 x_8))))
(assert (sum x_30 (+ x_33 (+ x_24 x_29))))
(assert (sum x_39 (+ x_31 (+ x_27 x_5))))
(assert (sum x_39 (+ x_9 (+ x_31 x_3))))
(assert (sum x_22 (+ x_40 (+ x_7 x_1))))
(assert (sum x_18 (+ x_44 (+ x_36 x_27))))
(assert (sum x_4 (+ x_0 (+ x_15 x_33))))
(assert (sum x_30 (+ x_28 (+ x_38 x_15))))
(assert (sum x_41 (+ x_32 (+ x_21 x_34))))
(check-sat)
(exit)