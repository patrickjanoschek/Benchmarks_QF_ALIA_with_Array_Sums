...
(assert (sum x_27 (+ x_36 (+ x_18 x_9))))
(assert (sum x_49 (+ x_51 (+ x_24 x_29))))
(assert (sum x_19 (+ x_13 (+ x_13 x_30))))
(assert (sum x_19 (+ x_30 (+ x_3 x_28))))
(assert (sum x_15 (+ x_1 (+ x_30 x_38))))
(assert (sum x_23 (+ x_14 (+ x_28 x_32))))
(assert (sum x_4 (+ x_34 (+ x_35 x_20))))
(assert (sum x_46 (+ x_18 (+ x_3 x_48))))
(assert (sum x_19 (+ x_8 (+ x_26 x_10))))
(assert (sum x_2 (+ x_51 (+ x_22 x_5))))
(check-sat)
(exit)