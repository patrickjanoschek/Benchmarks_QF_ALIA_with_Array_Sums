...
Base file: stack-invalid-6.smt2")
(set-info :source |
...
(assert (sum x_27 (+ x_25 (+ x_18 x_13))))
(assert (sum x_31 (+ x_26 (+ x_8 x_33))))
(assert (sum x_38 (+ x_24 (+ x_29 x_13))))
(assert (sum x_36 (+ x_26 (+ x_5 x_9))))
(assert (sum x_31 (+ x_30 (+ x_4 x_28))))
(assert (sum x_19 (+ x_2 (+ x_26 x_0))))
(assert (sum x_3 (+ x_14 (+ x_33 x_28))))
(assert (sum x_31 (+ x_14 (+ x_32 x_21))))
(assert (sum x_37 (+ x_12 (+ x_20 x_18))))
(assert (sum x_23 (+ x_18 (+ x_24 x_14))))
(check-sat)
(exit)