...
(assert (sum x_34 (+ x_69 (+ x_20 x_89))))
(assert (sum x_21 (+ x_100 (+ x_104 x_92))))
(assert (sum x_34 (+ x_92 (+ x_105 x_32))))
(assert (sum x_8 (+ x_70 (+ x_1 x_105))))
(assert (sum x_28 (+ x_40 (+ x_51 x_1))))
(assert (sum x_67 (+ x_30 (+ x_65 x_76))))
(assert (sum x_21 (+ x_56 (+ x_77 x_97))))
(assert (sum x_2 (+ x_20 (+ x_79 x_79))))
(assert (sum x_67 (+ x_63 (+ x_79 x_68))))
(assert (sum x_54 (+ x_72 (+ x_81 x_3))))
(check-sat)
(exit)