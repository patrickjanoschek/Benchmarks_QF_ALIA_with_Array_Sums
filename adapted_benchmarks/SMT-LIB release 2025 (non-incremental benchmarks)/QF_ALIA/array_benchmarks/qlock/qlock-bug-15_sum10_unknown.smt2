...
(assert (sum x_127 (+ x_87 (+ x_176 x_276))))
(assert (sum x_103 (+ x_29 (+ x_99 x_214))))
(assert (sum x_31 (+ x_25 (+ x_178 x_120))))
(assert (sum x_158 (+ x_13 (+ x_121 x_72))))
(assert (sum x_74 (+ x_174 (+ x_113 x_124))))
(assert (sum x_79 (+ x_12 (+ x_222 x_48))))
(assert (sum x_158 (+ x_253 (+ x_109 x_211))))
(assert (sum x_31 (+ x_68 (+ x_140 x_178))))
(assert (sum x_62 (+ x_1 (+ x_180 x_73))))
(assert (sum x_163 (+ x_143 (+ x_4 x_73))))
(check-sat)
(exit)