...
(assert (sum x_31 (+ x_69 (+ x_22 x_89))))
(assert (sum x_19 (+ x_100 (+ x_92 x_92))))
(assert (sum x_31 (+ x_34 (+ x_3 x_30))))
(assert (sum x_19 (+ x_41 (+ x_52 x_1))))
(assert (sum x_6 (+ x_81 (+ x_77 x_29))))
(assert (sum x_2 (+ x_66 (+ x_76 x_58))))
(assert (sum x_62 (+ x_77 (+ x_97 x_22))))
(assert (sum x_50 (+ x_79 (+ x_79 x_64))))
(assert (sum x_26 (+ x_79 (+ x_68 x_72))))
(assert (sum x_62 (+ x_81 (+ x_3 x_68))))
(check-sat)
(exit)