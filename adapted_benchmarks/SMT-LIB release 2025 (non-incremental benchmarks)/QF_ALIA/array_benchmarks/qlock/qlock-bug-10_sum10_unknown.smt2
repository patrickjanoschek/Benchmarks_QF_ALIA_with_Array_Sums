...
(assert (sum x_31 (+ x_125 (+ x_22 x_139))))
(assert (sum x_38 (+ x_135 (+ x_154 x_101))))
(assert (sum x_115 (+ x_119 (+ x_149 x_132))))
(assert (sum x_38 (+ x_182 (+ x_72 x_1))))
(assert (sum x_7 (+ x_119 (+ x_190 x_52))))
(assert (sum x_6 (+ x_120 (+ x_66 x_80))))
(assert (sum x_115 (+ x_22 (+ x_70 x_140))))
(assert (sum x_2 (+ x_75 (+ x_87 x_163))))
(assert (sum x_62 (+ x_70 (+ x_167 x_29))))
(assert (sum x_122 (+ x_99 (+ x_25 x_164))))
(check-sat)
(exit)