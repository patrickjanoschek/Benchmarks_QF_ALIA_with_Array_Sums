...
(assert (sum x_223 (+ x_333 (+ x_144 x_97))))
(assert (sum x_115 (+ x_164 (+ x_277 x_119))))
(assert (sum x_223 (+ x_135 (+ x_204 x_176))))
(assert (sum x_122 (+ x_356 (+ x_254 x_339))))
(assert (sum x_6 (+ x_216 (+ x_30 x_315))))
(assert (sum x_139 (+ x_333 (+ x_252 x_234))))
(assert (sum x_151 (+ x_70 (+ x_75 x_306))))
(assert (sum x_242 (+ x_176 (+ x_369 x_181))))
(assert (sum x_158 (+ x_29 (+ x_224 x_336))))
(assert (sum x_86 (+ x_120 (+ x_20 x_304))))
(check-sat)
(exit)