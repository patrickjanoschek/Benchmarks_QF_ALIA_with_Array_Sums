...
Base file: ios_t1_ios_bia_np_sf_ai_00015_001.cvc.smt2")
(set-info :source |
...
(assert (= a_45 (store a_42 e_43 e_44)))
(assert (= a_48 (store a e_40 e_47)))
(assert (= a_50 (store a_48 e_37 e_49)))
(assert (= a_52 (store a_50 e_34 e_51)))
(assert (= a_54 (store a_52 e_31 e_53)))
(assert (= a_56 (store a_54 e_28 e_55)))
(assert (= a_58 (store a_56 e_25 e_57)))
(assert (= a_6 (store a_3 e_4 e_5)))
(assert (= a_60 (store a_58 e_22 e_59)))
(assert (= a_62 (store a_60 e_19 e_61)))
(assert (= a_64 (store a_62 e_16 e_63)))
(assert (= a_66 (store a_64 e_13 e_65)))
(assert (= a_68 (store a_66 e_10 e_67)))
(assert (= a_70 (store a_68 e_7 e_69)))
(assert (= a_72 (store a_70 e_4 e_71)))
(assert (= a_74 (store a_72 e_0 e_73)))
(assert (= a_77 (store a_74 e_75 e_76)))
...
(assert (= e_8 (+ e_1 3)))
(assert (= a_45 a_77))
(assert (not (= e_44 e_46)))
; --- Injected Array Sum Constraint ---
(assert (sum a_33 (+ e_63 (+ e_31 e_11))))
(assert (sum a_68 (+ e_25 (+ e_19 e_41))))
(assert (sum a_74 (+ e_1 (+ e_34 e_44))))
(assert (sum a_50 (+ e_16 (+ e_71 e_17))))
(assert (sum a_74 (+ e_76 (+ e_55 e_25))))
(assert (sum a_54 (+ e_1 (+ e_14 e_69))))
(assert (sum a_21 (+ e_11 (+ e_46 e_31))))
(assert (sum a_56 (+ e_41 (+ e_71 e_53))))
(assert (sum a_30 (+ e_2 (+ e_57 e_25))))
(assert (sum a_21 (+ e_49 (+ e_8 e_26))))
(check-sat)
(exit)