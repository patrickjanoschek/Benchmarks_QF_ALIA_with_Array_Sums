...
Base file: ios_t1_ios_bia_np_sf_ai_00013_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_56 (+ e_8 (+ e_4 e_26))))
(assert (sum a (+ e_51 (+ e_51 e_4))))
(assert (sum a_60 (+ e_7 (+ e_22 e_65))))
(assert (sum a_15 (+ e_61 (+ e_29 e_1))))
(assert (sum a_18 (+ e_1 (+ e_45 e_38))))
(assert (sum a_24 (+ e_41 (+ e_51 e_14))))
(assert (sum a_12 (+ e_51 (+ e_11 e_20))))
(assert (sum a_12 (+ e_29 (+ e_63 e_4))))
(assert (sum a_56 (+ e_13 (+ e_55 e_14))))
(assert (sum a_15 (+ e_37 (+ e_20 e_28))))
(check-sat)
(exit)