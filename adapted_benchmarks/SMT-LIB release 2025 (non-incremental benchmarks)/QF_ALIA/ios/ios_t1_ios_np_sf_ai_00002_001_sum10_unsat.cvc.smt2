...
(assert (sum a (+ elem_4 (+ elem_8 i))))
(assert (sum earray_3 (+ i (+ elem_0 i))))
(assert (sum earray_11 (+ elem_8 (+ elem_8 elem_10))))
(assert (sum earray_11 (+ elem_0 (+ elem_8 elem_10))))
(assert (sum earray_6 (+ elem_7 (+ i elem_7))))
(assert (sum earray_11 (+ i (+ elem_8 elem_1))))
(assert (sum earray_6 (+ elem_0 (+ elem_7 elem_7))))
(assert (sum a (+ elem_8 (+ elem_4 elem_10))))
(assert (sum earray_3 (+ elem_8 (+ elem_5 elem_10))))
(check-sat)
(exit)