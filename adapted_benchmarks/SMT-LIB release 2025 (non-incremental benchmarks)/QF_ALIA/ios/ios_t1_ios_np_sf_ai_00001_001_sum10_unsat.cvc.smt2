...
(assert (sum earray_6 (+ elem_0 (+ elem_0 elem_4))))
(assert (sum earray_6 (+ elem_2 (+ i elem_5))))
(assert (sum earray_6 (+ elem_2 (+ elem_4 elem_4))))
(assert (sum a (+ elem_2 (+ elem_4 elem_2))))
(assert (sum a (+ elem_1 (+ elem_2 elem_2))))
(check-sat)
(exit)