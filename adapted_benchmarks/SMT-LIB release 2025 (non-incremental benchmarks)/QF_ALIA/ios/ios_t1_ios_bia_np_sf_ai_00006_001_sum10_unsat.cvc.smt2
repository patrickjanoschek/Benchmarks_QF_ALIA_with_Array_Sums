...
Base file: ios_t1_ios_bia_np_sf_ai_00006_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_18 (+ e_0 (+ e_13 e_2))))
(assert (sum a_27 (+ e_19 (+ e_16 e_19))))
(assert (sum a_32 (+ e_17 (+ e_22 e_1))))
(assert (sum a_12 (+ e_13 (+ e_10 e_22))))
(assert (sum a_27 (+ e_17 (+ i e_10))))
(assert (sum a_12 (+ e_13 (+ e_26 e_16))))
(assert (sum a_18 (+ e_19 (+ e_28 e_28))))
(assert (sum a_23 (+ e_2 (+ e_24 e_5))))
(assert (sum a_18 (+ e_16 (+ e_31 e_7))))
(assert (sum a_12 (+ e_11 (+ e_13 e_16))))
(check-sat)
(exit)