...
Base file: ios_t1_ios_bia_np_sf_ai_00011_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_46 (+ e_10 (+ i e_16))))
(assert (sum a_6 (+ e_31 (+ e_11 e_41))))
(assert (sum a_33 (+ e_25 (+ e_19 e_43))))
(assert (sum a_6 (+ e_34 (+ e_47 e_16))))
(assert (sum a_15 (+ e_17 (+ e_7 e_25))))
(assert (sum a_50 (+ e_1 (+ e_14 e_11))))
(assert (sum a_21 (+ e_49 (+ e_31 e_43))))
(assert (sum a_52 (+ e_56 (+ e_2 e_8))))
(assert (sum a_30 (+ e_25 (+ e_51 e_26))))
(assert (sum a_21 (+ e_17 (+ e_25 e_39))))
(check-sat)
(exit)