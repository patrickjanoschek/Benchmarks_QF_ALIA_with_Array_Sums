...
Base file: ios_t1_ios_bia_np_sf_ai_00008_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_21 (+ e_13 (+ e_40 e_16))))
(assert (sum a_39 (+ e_20 (+ e_11 e_23))))
(assert (sum a_6 (+ e_16 (+ e_8 e_34))))
(assert (sum a_15 (+ e_23 (+ e_5 e_38))))
(assert (sum a_33 (+ e_14 (+ i i))))
(assert (sum a_37 (+ e_0 (+ e_5 e_8))))
(assert (sum a_37 (+ e_5 (+ e_36 e_23))))
(assert (sum a_35 (+ e_19 (+ e_10 e_16))))
(assert (sum a_29 (+ e_14 (+ e_17 e_8))))
(assert (sum a_12 (+ e_19 (+ e_13 e_0))))
(check-sat)
(exit)