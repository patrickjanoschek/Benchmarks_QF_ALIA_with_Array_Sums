...
(assert (sum earray_48 (+ elem_0 (+ elem_40 elem_16))))
(assert (sum earray_44 (+ elem_19 (+ elem_4 elem_0))))
(assert (sum earray_42 (+ elem_29 (+ elem_17 elem_57))))
(assert (sum earray_30 (+ elem_57 (+ elem_53 elem_13))))
(assert (sum earray_64 (+ i (+ elem_65 elem_8))))
(assert (sum earray_39 (+ elem_45 (+ elem_16 elem_19))))
(assert (sum earray_56 (+ elem_17 (+ elem_22 elem_55))))
(check-sat)
(exit)