...
Base file: ios_t1_ios_bia_np_sf_ai_00012_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_33 (+ e_61 (+ e_54 e_4))))
(assert (sum a_47 (+ e_52 (+ e_52 e_4))))
(assert (sum a_6 (+ e_22 (+ e_8 e_1))))
(assert (sum a_18 (+ e_61 (+ e_29 e_1))))
(assert (sum a_51 (+ e_1 (+ e_46 e_38))))
(assert (sum a_24 (+ e_42 (+ e_52 e_14))))
(assert (sum a_12 (+ e_52 (+ e_11 e_20))))
(assert (sum a_12 (+ e_29 (+ e_7 e_4))))
(assert (sum a_55 (+ e_13 (+ e_56 e_14))))
