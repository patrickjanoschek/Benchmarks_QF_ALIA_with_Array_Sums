...
Base file: ios_t1_ios_np_sf_ai_00005_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_12 (+ elem_10 (+ elem_13 elem_5))))
(assert (sum earray_18 (+ elem_13 (+ elem_4 elem_16))))
(assert (sum earray_12 (+ elem_19 (+ elem_5 elem_5))))
(assert (sum earray_9 (+ elem_25 (+ elem_16 elem_8))))
(assert (sum earray_9 (+ elem_11 (+ elem_13 elem_16))))
(assert (sum a (+ elem_1 (+ elem_2 elem_25))))
(assert (sum earray_20 (+ elem_14 (+ elem_23 elem_23))))
(assert (sum earray_26 (+ elem_21 (+ elem_16 elem_0))))
(assert (sum a (+ elem_0 (+ elem_25 elem_19))))
(assert (sum earray_18 (+ elem_10 (+ elem_16 elem_14))))
(check-sat)
(exit)