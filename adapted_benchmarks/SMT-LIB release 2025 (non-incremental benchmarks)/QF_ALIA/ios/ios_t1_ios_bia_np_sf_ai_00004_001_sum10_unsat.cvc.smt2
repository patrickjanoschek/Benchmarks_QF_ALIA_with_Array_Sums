...
Base file: ios_t1_ios_bia_np_sf_ai_00004_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_6 (+ e_2 (+ e_18 e_4))))
(assert (sum a_15 (+ i (+ e_16 e_16))))
(assert (sum a_12 (+ e_7 (+ e_18 e_13))))
(assert (sum a_17 (+ e_14 (+ e_21 e_10))))
(assert (sum a_9 (+ e_0 (+ e_10 e_13))))
(assert (sum a_17 (+ e_21 (+ e_2 e_8))))
(assert (sum a_12 (+ e_8 (+ e_20 e_20))))
(assert (sum a_22 (+ e_4 (+ e_5 e_10))))
(assert (sum a_6 (+ e_8 (+ i e_16))))
(assert (sum a_6 (+ e_0 (+ e_11 e_5))))
(check-sat)
(exit)