...
Base file: ios_t1_ios_np_sf_ai_00010_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_33 (+ i (+ elem_40 elem_26))))
(assert (sum earray_33 (+ elem_22 (+ elem_1 elem_10))))
(assert (sum earray_9 (+ elem_29 (+ elem_1 elem_1))))
(assert (sum earray_24 (+ elem_0 (+ elem_32 elem_1))))
(assert (sum earray_12 (+ elem_44 (+ elem_8 elem_14))))
(assert (sum earray_21 (+ elem_14 (+ elem_38 elem_20))))
(assert (sum earray_37 (+ elem_28 (+ i elem_19))))
(assert (sum earray_49 (+ elem_14 (+ elem_28 elem_5))))
(assert (sum earray_27 (+ elem_10 (+ elem_34 elem_32))))
(assert (sum earray_24 (+ elem_44 (+ elem_10 elem_32))))
(check-sat)
(exit)