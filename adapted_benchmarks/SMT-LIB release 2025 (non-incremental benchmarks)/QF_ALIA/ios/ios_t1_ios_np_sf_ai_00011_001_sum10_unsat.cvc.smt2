...
Base file: ios_t1_ios_np_sf_ai_00011_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_33 (+ elem_31 (+ elem_11 elem_41))))
(assert (sum earray_44 (+ elem_19 (+ elem_43 elem_1))))
(assert (sum earray_52 (+ elem_34 (+ elem_47 elem_16))))
(assert (sum earray_40 (+ elem_8 (+ elem_25 elem_29))))
(assert (sum earray_30 (+ i (+ elem_11 elem_1))))
(assert (sum earray_27 (+ elem_49 (+ elem_31 elem_43))))
(assert (sum earray_9 (+ elem_7 (+ elem_2 i))))
(assert (sum earray_36 (+ elem_25 (+ elem_51 elem_26))))
(assert (sum earray_21 (+ elem_17 (+ elem_25 elem_39))))
(assert (sum earray_9 (+ elem_35 (+ elem_28 elem_31))))
(check-sat)
(exit)