...
Base file: ios_t1_ios_np_sf_ai_00008_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_12 (+ elem_19 (+ i elem_14))))
(assert (sum earray_9 (+ elem_36 (+ i elem_11))))
(assert (sum earray_18 (+ elem_34 (+ elem_8 elem_10))))
(assert (sum earray_29 (+ elem_0 (+ elem_17 elem_16))))
(assert (sum earray_31 (+ elem_32 (+ elem_17 elem_0))))
(assert (sum earray_35 (+ elem_8 (+ elem_28 elem_7))))
(assert (sum earray_33 (+ elem_36 (+ elem_30 elem_1))))
(assert (sum earray_18 (+ elem_0 (+ elem_28 elem_22))))
(assert (sum earray_29 (+ elem_13 (+ elem_13 i))))
(assert (sum earray_9 (+ elem_40 (+ elem_19 elem_19))))
(check-sat)
(exit)