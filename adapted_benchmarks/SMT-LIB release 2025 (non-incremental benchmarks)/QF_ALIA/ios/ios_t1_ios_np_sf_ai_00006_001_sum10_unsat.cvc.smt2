...
Base file: ios_t1_ios_np_sf_ai_00006_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_12 (+ elem_8 (+ elem_20 elem_4))))
(assert (sum earray_29 (+ elem_14 (+ elem_17 elem_8))))
(assert (sum earray_21 (+ elem_10 (+ elem_30 elem_10))))
(assert (sum earray_3 (+ elem_5 (+ elem_26 elem_5))))
(assert (sum a (+ elem_1 (+ elem_10 elem_30))))
(assert (sum a (+ elem_0 (+ elem_26 i))))
(assert (sum earray_3 (+ elem_30 (+ elem_8 elem_17))))
(assert (sum earray_21 (+ elem_16 (+ elem_10 elem_4))))
(assert (sum earray_12 (+ elem_0 (+ elem_30 elem_22))))
(assert (sum earray_21 (+ elem_7 (+ elem_26 elem_14))))
(check-sat)
(exit)