...
Base file: ios_t1_ios_bia_np_sf_ai_00007_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_21 (+ e_11 (+ e_13 e_7))))
(assert (sum a_28 (+ e_27 (+ e_20 e_11))))
(assert (sum a_6 (+ e_23 (+ e_16 e_35))))
(assert (sum a_26 (+ e_1 (+ e_2 e_23))))
(assert (sum a_37 (+ i (+ e_4 e_14))))
(assert (sum a_37 (+ e_20 (+ e_7 i))))
(assert (sum a_37 (+ e_16 (+ e_0 e_0))))
(assert (sum a_37 (+ i (+ i e_36))))
(assert (sum a_37 (+ e_23 (+ e_19 e_10))))
(assert (sum a_21 (+ e_16 (+ e_14 e_17))))
(check-sat)
(exit)