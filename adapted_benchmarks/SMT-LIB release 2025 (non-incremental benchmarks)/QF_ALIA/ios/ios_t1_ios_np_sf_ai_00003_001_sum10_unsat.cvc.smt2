...
Base file: ios_t1_ios_np_sf_ai_00003_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_3 (+ elem_2 (+ elem_11 elem_5))))
(assert (sum earray_12 (+ elem_1 (+ elem_4 elem_0))))
(assert (sum a (+ elem_8 (+ i elem_5))))
(assert (sum earray_12 (+ elem_2 (+ elem_7 elem_10))))
(assert (sum earray_14 (+ elem_2 (+ i elem_7))))
(assert (sum earray_12 (+ elem_0 (+ i elem_13))))
(assert (sum earray_3 (+ elem_13 (+ elem_8 elem_2))))
(assert (sum earray_3 (+ elem_5 (+ elem_5 elem_10))))
(assert (sum earray_12 (+ elem_10 (+ elem_10 elem_11))))
(assert (sum earray_14 (+ elem_4 (+ elem_15 elem_4))))
(check-sat)
(exit)