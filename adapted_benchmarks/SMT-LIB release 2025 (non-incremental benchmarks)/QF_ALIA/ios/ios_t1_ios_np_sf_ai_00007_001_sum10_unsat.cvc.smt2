...
Base file: ios_t1_ios_np_sf_ai_00007_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_12 (+ elem_29 (+ elem_22 elem_13))))
(assert (sum earray_24 (+ elem_8 (+ elem_19 elem_19))))
(assert (sum earray_34 (+ elem_10 (+ elem_35 elem_29))))
(assert (sum earray_18 (+ i (+ elem_7 i))))
(assert (sum earray_21 (+ elem_0 (+ i elem_4))))
(assert (sum earray_34 (+ elem_17 (+ elem_4 elem_10))))
(assert (sum earray_12 (+ elem_29 (+ elem_10 elem_33))))
(assert (sum earray_3 (+ elem_25 (+ elem_33 elem_1))))
(assert (sum earray_21 (+ elem_7 (+ elem_10 elem_29))))
(assert (sum earray_26 (+ elem_19 (+ elem_11 elem_0))))
(check-sat)
(exit)