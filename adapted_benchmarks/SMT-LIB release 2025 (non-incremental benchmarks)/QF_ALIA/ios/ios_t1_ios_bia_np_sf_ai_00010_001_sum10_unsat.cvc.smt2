...
Base file: ios_t1_ios_bia_np_sf_ai_00010_001.cvc.smt2")
(set-info :source |
...
(assert (sum a_41 (+ e_26 (+ e_5 e_23))))
(assert (sum a_3 (+ e_38 (+ e_48 e_1))))
(assert (sum a_6 (+ e_14 (+ e_48 e_48))))
(assert (sum a_39 (+ e_34 (+ e_50 e_20))))
(assert (sum a_39 (+ e_48 (+ e_42 e_8))))
(assert (sum a_12 (+ e_14 (+ e_17 e_46))))
(assert (sum a_9 (+ e_19 (+ e_8 e_40))))
(assert (sum a_41 (+ e_26 (+ e_7 e_7))))
(assert (sum a_33 (+ e_40 (+ e_22 e_1))))
(assert (sum a_18 (+ e_10 (+ e_29 e_1))))
(check-sat)
(exit)