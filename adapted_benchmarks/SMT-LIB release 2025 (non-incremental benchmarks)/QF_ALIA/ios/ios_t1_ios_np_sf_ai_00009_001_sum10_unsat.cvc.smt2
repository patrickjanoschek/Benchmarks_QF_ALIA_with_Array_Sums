...
Base file: ios_t1_ios_np_sf_ai_00009_001.cvc.smt2")
(set-info :source |
...
(assert (sum earray_30 (+ elem_5 (+ elem_19 i))))
(assert (sum earray_24 (+ elem_33 (+ elem_2 elem_22))))
(assert (sum earray_12 (+ elem_41 (+ elem_26 elem_5))))
(assert (sum earray_32 (+ i (+ elem_29 elem_45))))
(assert (sum earray_6 (+ elem_35 (+ elem_22 i))))
(assert (sum earray_3 (+ elem_29 (+ elem_41 elem_29))))
(assert (sum earray_15 (+ elem_5 (+ elem_29 elem_1))))
(assert (sum earray_18 (+ elem_1 (+ elem_7 elem_39))))
(assert (sum earray_6 (+ elem_4 (+ elem_13 elem_0))))
(assert (sum earray_24 (+ elem_0 (+ elem_33 i))))
(check-sat)
(exit)