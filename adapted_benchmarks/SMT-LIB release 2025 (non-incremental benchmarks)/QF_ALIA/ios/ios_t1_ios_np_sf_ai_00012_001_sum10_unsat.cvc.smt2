...
(assert (sum earray_21 (+ elem_29 (+ elem_46 elem_5))))
(assert (sum earray_18 (+ elem_48 (+ elem_14 elem_58))))
(assert (sum earray_33 (+ elem_50 (+ elem_58 elem_54))))
(assert (sum earray_24 (+ elem_35 (+ elem_52 elem_38))))
(assert (sum earray_9 (+ elem_54 (+ elem_10 elem_31))))
(assert (sum earray_51 (+ elem_40 (+ elem_50 elem_10))))
(assert (sum earray_45 (+ elem_4 (+ elem_52 elem_37))))
(check-sat)
(exit)