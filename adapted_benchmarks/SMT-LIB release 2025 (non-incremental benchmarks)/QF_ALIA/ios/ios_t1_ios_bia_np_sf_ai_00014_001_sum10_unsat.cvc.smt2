...
(assert (sum a_45 (+ e_37 (+ e_44 e_1))))
(assert (sum a_3 (+ e_7 (+ e_8 e_14))))
(assert (sum a_9 (+ e_48 (+ e_20 e_44))))
(assert (sum a_9 (+ e_40 (+ e_64 e_52))))
(assert (sum a_42 (+ e_0 (+ e_43 e_23))))
(assert (sum a_42 (+ e_68 (+ e_10 e_64))))
(assert (sum a_59 (+ e_14 (+ e_17 e_43))))
(check-sat)
(exit)