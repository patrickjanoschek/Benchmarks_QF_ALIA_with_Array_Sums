...
(assert (sum x_12 (+ x_121 (+ x_228 x_166))))
(assert (sum x_171 (+ x_156 (+ x_44 x_228))))
(assert (sum x_163 (+ x_134 (+ x_236 x_238))))
(assert (sum x_98 (+ x_193 (+ x_175 x_86))))
(assert (sum x_14 (+ x_203 (+ x_73 x_210))))
(assert (sum x_10 (+ x_190 (+ x_245 x_82))))
(assert (sum x_4 (+ x_153 (+ x_198 x_127))))
(check-sat)
(exit)