...
(assert (sum x_163 (+ x_393 (+ x_19 x_309))))
(assert (sum x_51 (+ x_69 (+ x_463 x_417))))
(assert (sum x_171 (+ x_118 (+ x_444 x_505))))
(assert (sum x_45 (+ x_46 (+ x_264 x_104))))
(assert (sum x_317 (+ x_497 (+ x_64 x_437))))
(assert (sum x_17 (+ x_387 (+ x_244 x_479))))
(assert (sum x_7 (+ x_279 (+ x_57 x_208))))
(assert (sum x_31 (+ x_258 (+ x_344 x_428))))
(assert (sum x_283 (+ x_381 (+ x_346 x_274))))
(assert (sum x_17 (+ x_322 (+ x_243 x_373))))
(check-sat)
(exit)