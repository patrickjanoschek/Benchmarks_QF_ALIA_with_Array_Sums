...
(assert (sum x_37 (+ x_28 (+ x_388 x_214))))
(assert (sum x_115 (+ x_114 (+ x_375 x_19))))
(assert (sum x_17 (+ x_301 (+ x_324 x_69))))
(assert (sum x_7 (+ x_118 (+ x_323 x_46))))
(assert (sum x_129 (+ x_264 (+ x_104 x_64))))
(assert (sum x_269 (+ x_369 (+ x_244 x_277))))
(assert (sum x_17 (+ x_57 (+ x_208 x_258))))
(assert (sum x_7 (+ x_329 (+ x_363 x_330))))
(assert (sum x_31 (+ x_274 (+ x_311 x_243))))
(assert (sum x_17 (+ x_355 (+ x_272 x_266))))
(check-sat)
(exit)