...
(assert (sum a1 (+ length1 (+ k length3))))
(assert (sum a1 (+ length1 (+ i1 length1))))
(assert (sum a2 (+ length5 (+ k length1))))
(assert (sum a2 (+ length2 (+ length5 length2))))
(assert (sum a2 (+ i2 (+ length1 length1))))
(assert (sum a1 (+ i1 (+ length4 length5))))
(assert (sum a2 (+ length4 (+ i2 k))))
(assert (sum a2 (+ length4 (+ length3 i1))))
(assert (sum a1 (+ k (+ i1 length4))))
(assert (sum a2 (+ i1 (+ i2 k))))
(check-sat)
(exit)