...
(assert (sum a1_0 (+ length2 (+ i_1 length5))))
(assert (sum a1_0 (+ k (+ length5 i_1))))
(assert (sum a2_0 (+ i_1 (+ length4 i1))))
(assert (sum a1_0 (+ j_2 (+ length3 i1))))
(assert (sum a2_0 (+ j_2 (+ i_1 length2))))
(assert (sum buf (+ length1 (+ i1 i_1))))
(assert (sum a2_0 (+ i_1 (+ length3 length3))))
(assert (sum buf (+ length3 (+ length2 k))))
(assert (sum a2_0 (+ i2 (+ k length5))))
(assert (sum buf (+ k (+ length2 length5))))
(check-sat)
(exit)