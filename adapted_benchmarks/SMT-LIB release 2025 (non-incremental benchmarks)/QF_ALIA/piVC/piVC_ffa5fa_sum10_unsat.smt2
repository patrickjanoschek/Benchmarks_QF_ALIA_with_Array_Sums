...
(assert (sum a1 (+ length2 (+ length2 length3))))
(assert (sum a1 (+ length2 (+ length1 length2))))
(assert (sum a1 (+ length1 (+ length3 length3))))
(assert (sum a1 (+ length3 (+ length1 length2))))
(assert (sum a2 (+ length3 (+ length2 length1))))
(assert (sum a2 (+ length3 (+ length2 length2))))
(assert (sum a2 (+ length2 (+ length1 length3))))
(assert (sum a1 (+ length1 (+ length1 length2))))
(assert (sum a1 (+ length1 (+ length2 length3))))
(assert (sum a1 (+ length2 (+ length3 length2))))
(check-sat)
(exit)